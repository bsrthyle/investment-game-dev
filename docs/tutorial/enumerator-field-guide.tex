...
\begin{itemize}[leftmargin=1.4em,nosep]
  \item \textbf{Participant ID} (from your list),
  \item \textbf{Enumerator ID} (yours),
  \item \textbf{Treatment group} (Control / T1 / T2 / T3 --- from the main study; auto-fills if the
  participant list was imported).
\end{itemize}
Then tap \textbf{Start session}.
...
2{,}356 NGN}. Pay the Naira figure shown. Tap \textbf{Continue} for a short survey, then the
...
\textbf{Close the app and open it again.} It returns to the Welcome screen and \textbf{keeps all the
data from earlier participants}. Then tap \textbf{Begin} for the next person. You can run many
