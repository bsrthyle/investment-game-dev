...
\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}%
\fcolorbox{black!20}{white}{\includegraphics[width=0.8\linewidth]{img/08-briefing.png}}\\[2cm]
...
Good (green), 2 Normal (blue), 1 Drought (grey). \textbf{Right:} market price --- 2 of 10 High, 5 Mid, 3 Low.}
...
\textcolor{rainblue}{$=$} \textbf{Price --- Mid} & a normal price\\
...
tokens you would keep. Tap \textbf{Plant} when you are happy with your choice.}

\subsection{Step 3 --- Confirm (you cannot change it later)}

Once you tap Plant, the game asks you to confirm. \textbf{After you confirm you cannot change your decision}
--- just like in real life, once you have planted, you cannot un-plant.

\screenshot{img/10-confirm.png}{The confirmation. Tap \textbf{Go back} to change your mind, or
\textbf{Yes, plant now} to lock in your decision.}
...
\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}%
\fcolorbox{black!25}{white}{\includegraphics[width=\linewidth]{img/11-reveal-rain.png}}\\[2pt]
{\small\itshape\color{inkgrey} First: the rain result.}
\end{minipage}\hfill
\begin{minipage}{0.49\linewidth}\centering
\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}%
\fcolorbox{black!25}{white}{\includegraphics[width=\linewidth]{img/12-reveal-price.png}}\\[2pt]
...
and the price was high ($\times1.6$), so the fertilizer returned \textbf{6.9} --- much more than the 3 spent.
\textbf{Net = \profit{+3.9}}, and take-home is \textbf{28.9} tokens.}
...
price was \textbf{low} ($\times0.6$), so the fertilizer only returned \textbf{6.5}. \textbf{Net = \profit{+0.5}}
--- almost exactly break-even. A low price can wipe out your profit.}

\subsection{A loss --- the price did not cover the cost}

\screenshot{img/loss-s2.png}{Here the farmer invested \textbf{10} bags, but the price was \textbf{low}
($\times0.6$) and the fertilizer only returned \textbf{9.1} --- \emph{less} than the 10 spent.
\textbf{Net = \loss{-0.9}}: a loss. Take-home (24.1) is \emph{below} the 25 they started with.}
