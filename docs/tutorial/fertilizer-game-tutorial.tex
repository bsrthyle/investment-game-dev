...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{The market price.} When you sell your maize the price can be \textbf{high}, \textbf{normal},
...
At the start of \textbf{every} season you are given \textbf{25 tokens}. Tokens are \textbf{real money}:
each token is worth \textbf{5 Naira}, so 25 tokens is \textbf{125 Naira}. At the end of the game your
tokens are paid to you in real Naira.
\begin{itemize}[leftmargin=1.4em]
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item \textbf{Then look at the price picture.} Many high/normal squares means your harvest will sell well.
...
\begin{enumerate}[leftmargin=1.5em]
  \item \textbf{A short video} in your language that explains how the game works.
...
the game is also played in Hausa. The numbers in the examples are play-tokens.\\[4pt]
