...
// GAME.ICON_ARRAY.SIZE-icon array: at SIZE 10, probs [0.6,0.3,0.1] renders
// 6 good / 3 normal / 1 drought, so the drought-count answer is 1 and the
// distractors are the other two visible group counts (3, 6).
const QUESTIONS = [
  {
    id: 'drought_count',
